...
//electronics class extending product abstract class and implementing taxable interface
public class Eletronics extends Product implements Taxable{


    //initializing variables
    private float taxRate = 16.5F;
    private float discount = 10.5f;


    //constructor
    Eletronics(String productID, String productName, float price) {
